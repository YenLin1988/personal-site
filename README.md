...
author: '作者'
description: '一句話介紹。'
status: 'read'           # 'reading' | 'read' | 'wantToRead'
rating: 5                 # 1-5（可選）
dateRead: 2026-05-21      # 讀完日期（可選）
tags: ['哲學', '經典']
featured: true            # 是否在首頁／書單頂部置頂
# cover: ../../assets/books/cover.jpg   # 封面圖（可選，放到 src/assets/books/）
links:
  - label: 博客來
    url: https://www.books.com.tw/exep/assp.php/你的AP_ID/products/0010896601
  - label: Readmoo 讀墨
    url: https://readmoo.com/book/...
---
...
1. 到 [博客來 AP](https://ap.books.com.tw) 註冊
2. 拿到你的 AP_ID
3. 推書時用「推薦連結產生器」拿到帶 AP_ID 的網址，貼到 `links[].url`
4. 讀者點擊購買，博客來會給你回饋金

書單頁底部已自動顯示「* 部分連結為聯盟連結⋯」聲明（符合公平交易與廣告揭露慣例）。
